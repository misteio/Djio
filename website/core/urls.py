...
urlpatterns = [
    ...
    #Users
    url(r'^admin/users/list$', views.user_list_admin, name='user_list_admin'),
    url(r'^admin/users/create$', views.user_create_admin, name='user_create_admin'),
    url(r'^admin/users/update/(?P<user_id>[0-9]+)$', views.user_update_admin, name='user_update_admin'),
